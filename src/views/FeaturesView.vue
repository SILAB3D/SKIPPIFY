<template>
  <div>
    <h2 class="text-xl font-semibold mb-1">Funcionalidades</h2>
    <p class="text-sm text-slate-400 mb-6">Activa o desactiva las funciones de Skippify según tus preferencias.</p>
